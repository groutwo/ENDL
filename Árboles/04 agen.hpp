...
{ assert(r == NODO_NULO); /* árbol vacío */ r = new celda(e); }
...
template <typename T> inline bool Agen<T>::arbolVacio() const
{ return (r == NODO_NULO); }
