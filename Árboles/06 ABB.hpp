...
public:
    ...
    ///p4 ej1:
    void eliminarAPartirDe(const T&);
    ///p4 ej2:
...
{   if (r == 0 or r->elto == e) // árbol vacío, e no encontrado; o e en la raiz
        return *this;
